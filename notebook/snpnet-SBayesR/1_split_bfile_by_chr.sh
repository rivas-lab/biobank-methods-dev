...
--make-bed \
--out /oak/stanford/groups/mrivas/projects/biobank-methods-dev/snpnet-SBayesR/ukb24983_cal_c${chr}_v2_hg19_train_val
...
--pfile /oak/stanford/groups/mrivas/ukbb24983/cal/pgen/ukb24983_cal_cALL_v2_hg19 vzs \
--make-bed \
--out /oak/stanford/groups/mrivas/projects/biobank-methods-dev/snpnet-SBayesR/ukb24983_cal_c${chr}_v2_hg19_train
