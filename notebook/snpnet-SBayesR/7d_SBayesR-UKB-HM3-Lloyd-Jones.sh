...
out_d="${data_d}/SBayesR-UKB-HM3-Lloyd-Jones"

if [ ! -d ${out_d} ] ; then mkdir -p ${out_d} ; fi

gctb --sbayes R \
     --mldm /oak/stanford/groups/mrivas/public_data/SBayesR/ukbEURu_hm3_shrunk_sparse/ukbEURu_hm3_sparse_mldm_list.newpath.txt \
