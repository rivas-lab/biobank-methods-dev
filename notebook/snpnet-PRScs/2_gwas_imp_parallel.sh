...
# This `ml load plink2/20200725` updates the PATHs so that we can execute plink2 software.
...
# pfile="/oak/stanford/groups/mrivas/ukbb24983/array_imp_combined/pgen_v2/ukb24983_cal_hla_cnv_imp"
...
out_d="/oak/stanford/groups/mrivas/projects/biobank-methods-dev/snpnet-GWAS/sumstats_imp_train_val"
