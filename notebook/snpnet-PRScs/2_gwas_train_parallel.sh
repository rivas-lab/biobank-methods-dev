...
out_d="/oak/stanford/groups/mrivas/projects/biobank-methods-dev/snpnet-PRScs/sumstats_train"
...
if [ ! -s ${out_d}/${GBE_ID}.batch${batch_idx}.PHENO1.$(get_plink_suffix ${GBE_ID}) ] ; then
